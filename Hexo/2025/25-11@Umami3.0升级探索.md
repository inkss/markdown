...
最后，为了兼容 PostgreSQL 的语法规范，需要对 SQL 文件进行一次全局字符替换^[如果转换后的 SQL 文件导入过程中遇到失败，建议尝试使用专业的转换工具：[PGLoader](https://github.com/dimitri/pgloader)]：
...
![DataGrip](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/25-11@Umami3.0升级探索/image-20251112212926144.png)
