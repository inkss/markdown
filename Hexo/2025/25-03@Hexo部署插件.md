...
tag:
  ...
  - 前端开发
categories: 工具
description: 本文介绍一款 Hexo 部署插件，用于将静态文件上传至腾讯云对象存储（COS）并刷新 CDN/EdgeOne 缓存。说明其解决原有插件问题的背景，详解功能（文件上传、冗余文件清理、缓存刷新等）、安装使用方法、配置示例及注意事项，附项目地址。
date: '2025-03-09 16:30'
updated: '2025-07-26 13:40'
headimg: https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/25-03@Hexo部署插件/Hexo博客封面.png
abbrlink: db87531d
---
