...
tag:
  ...
  - 博客
categories: 前端
description: 本文介绍静态网站图片优化的方法，包括利用 sharp 库压缩图片并转换为 webp、avif 格式，通过 picture 标签处理浏览器兼容性，添加时间戳应对 CDN 缓存，实现图片懒加载及处理主题与灯箱兼容问题，附具体代码与使用指南。
date: '2024-12-27 15:30'
updated: '2025-03-10 23:33'
copyright:
  type: cc
headimg: https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/24-12@Hexo图片资源优化/Hexo博客封面.png
abbrlink: 9659af8e
---
...
![png 格式，997kb](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/24-12@Hexo图片资源优化/桌面背景.png)

![webp 格式，154kb](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/24-12@Hexo图片资源优化/桌面背景.webp)

![avif 格式，69kb](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/24-12@Hexo图片资源优化/桌面背景.avif)
{% endgallery %}
