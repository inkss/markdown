...
categories: 文档
toc: false
description: 本文整理了多种 Git 打包命令，包括打包最后一次提交文件、指定提交文件、两个版本 / 分支间差异文件，以及打包 Master、Head、Tag 等，在 Windows 下 powershell 测试通过。
abbrlink: 59d81549
headimg: https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/19-12@Git打包/Hexo博客封面.png
---
