...
tag:
  ...
  - 系统安装
categories: Linux
description: 本文详细记录 Ubuntu 18.04 的安装流程，包括系统安装（引导盘制作、分区、安装注意事项）、初始配置（更新、主题更换、输入法设置等）、后续完善（软件安装、文件备份、系统优化）及编程环境配置等内容。
abbrlink: c6df61d3
type: linux
icons:
  - fab fa-ubuntu red
headimg: https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/19-04@Ubuntu18.04安装记录/main.png
hideTitle: false
---
...
![外观配置](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/19-04@Ubuntu18.04安装记录/image-20200507105957944.png)
...
![Grub Customizer](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/19-04@Ubuntu18.04安装记录/image-20200507110107616.png)
...
![GDM](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/19-04@Ubuntu18.04安装记录/image-20200507110222935.png)
...
![超级推荐的软件](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/19-04@Ubuntu18.04安装记录/image-20200507110243274.png)
...
{% gallery 3 %}
![桌面](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/19-04@Ubuntu18.04安装记录/image-20200507110318847.png)
![软件列表](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/19-04@Ubuntu18.04安装记录/image-20200507110337914.png)
![系统](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/19-04@Ubuntu18.04安装记录/image-20200507110355777.png)
{% endgallery %}