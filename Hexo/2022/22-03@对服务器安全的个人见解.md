...
categories: 网络技术
description: >-
  本文分享对服务器安全的个人见解，涵盖云服务商层面的登录凭证、防火墙策略，应用控制中的 SSH 配置、Web 应用安全（如 DNS 隐藏、访问限制、防火墙部署等），以及面板和数据库的安全设置，提供具体规则与配置示例。
...
headimg: https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/22-03@对服务器安全的个人见解/Hexo博客封面.png
copyright:
  type: type2
---
...
![防火墙](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/22-03@对服务器安全的个人见解/image-20250310144248363.png)
...
![Cloudflare 重定向规则](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/22-03@对服务器安全的个人见解/image-20250327191533376.png)
