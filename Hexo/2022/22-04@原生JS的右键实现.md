...
tag:
  ...
  - 右键菜单
categories: 前端
description: 本文介绍如何使用原生 JavaScript 实现自定义右键菜单，涵盖菜单的创建、显示 / 隐藏逻辑、点击事件绑定，以及与默认右键菜单的冲突处理，附具体代码示例与实现思路。
...
headimg: https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/22-04@原生JS的右键实现/Hexo博客封面.png
---

{% image https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/22-04@原生JS的右键实现/image-20220418232017851.png::height=266px %}
...
![预置菜单功能](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/22-04@原生JS的右键实现/自定义右键.svg)
