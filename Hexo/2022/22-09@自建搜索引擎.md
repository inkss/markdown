...
abbrlink: 19f14ef1
headimg: https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/22-09@自建搜索引擎/Hexo博客封面.png
references:
...
![Diagram illustration Meilisearch's document structure](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/22-09@自建搜索引擎/document_structure.svg)
...
![Default Search API Key](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/22-09@自建搜索引擎/image-20220903114123344.png)
...
![更改对应参数](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/22-09@自建搜索引擎/image-20220903112249534.png)
