...
headimg: https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/21-03@微信小程序之小程序码生成/Hexo博客封面.png
hideTitle: false
description: 本文介绍微信小程序中生成小程序码的方法，重点讲解使用 getUnlimited 接口的实现流程，包括获取 access_token、接口参数配置，以及小程序端读取参数的方式，附 Java 版本的代码示例。
---
...
{% image https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/21-03@微信小程序之小程序码生成/image-20210321003847805.png, alt='获取 Access Token' %}
...
{% image https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/21-03@微信小程序之小程序码生成/image-20210321005243537.png, alt='获取小程序码' %}
