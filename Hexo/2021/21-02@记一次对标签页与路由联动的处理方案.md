...
description: 本文介绍 Angular 后台管理项目中标签页与路由联动的处理方案，针对父子页面跳转场景，详解标签页新建、删除及路由复用策略，附事件处理、路由守卫等实现代码，解决子页面状态保留与关联关闭问题。
abbrlink: dfbd179
icons: [fab fa-angular red]
headimg: https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/21-02@记一次对标签页与路由联动的处理方案/Hexo博客封面.png
---
...
{% image https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/21-02@记一次对标签页与路由联动的处理方案/image-20210205141833759.png, bg=var(--color-card), height=260px, alt='页面结构' %}
...
{%image https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/21-02@记一次对标签页与路由联动的处理方案/pic.png , bg=#f7f7f7 %}
...
{%image https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/21-02@记一次对标签页与路由联动的处理方案/pic2.svg, bg=var(--color-white-png) %}
