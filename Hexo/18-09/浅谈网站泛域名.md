...
![DNS 域名解析 - 记录类型](https://img.inkss.cn/inkss_cn/img/2018/09/web-pandomain-name/01.png)
...
![申请泛域名分发](https://img.inkss.cn/inkss_cn/img/2018/09/web-pandomain-name/02.png)

除了需要验证外，其余的添加方法与普通 CDN 域名加速的设置项均相同。但是有一点需要注意：

全站 Https，泛域名的 SSL 证书 **必须要部署到 CDN** 上，否则 CDN 会用腾讯云的证书然后就证书不符报错啦。

![部署证书（可以不开强制跳转）](https://img.inkss.cn/inkss_cn/img/2018/09/web-pandomain-name/03.png)
