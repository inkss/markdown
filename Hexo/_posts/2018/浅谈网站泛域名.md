...
{% gallery %}
![DNS 域名解析 - 记录类型](https://img.inkss.cn/inkss/static/浅谈网站泛域名.assets/01.png)
{% endgallery %}
...
{% gallery %}
![申请泛域名分发](https://img.inkss.cn/inkss/static/浅谈网站泛域名.assets/02.png)
{% endgallery %}
...
{% gallery %}
![部署证书（可以不开强制跳转）](https://img.inkss.cn/inkss/static/浅谈网站泛域名.assets/03.png)
{% endgallery %}
