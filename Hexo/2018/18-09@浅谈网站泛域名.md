...
toc: true
indent: true
headimg: https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/18-09@浅谈网站泛域名/Hexo博客封面.png
---

{% note info , 本文主要介绍这些内容：<br> **DNS 泛域名解析**、**SSL 泛域名证书申请**、**CDN 泛域名加速（分发）。**
...
{% gallery %}
![DNS 域名解析 - 记录类型](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/18-09@浅谈网站泛域名/01.png)
{% endgallery %}
...
{% gallery %}
![申请泛域名分发](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/18-09@浅谈网站泛域名/02.png)
{% endgallery %}
...
{% gallery %}
![部署证书（可以不开强制跳转）](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/18-09@浅谈网站泛域名/03.png)
{% endgallery %}
