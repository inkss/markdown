---
uuid: 1bfa8316-283a-11ed-a81c-e5c20e2f9c97
...
{% gallery %}
![DNS 域名解析 - 记录类型](../../img/article/浅谈网站泛域名/01.png)
{% endgallery %}
...
{% gallery %}
![申请泛域名分发](../../img/article/浅谈网站泛域名/02.png)
{% endgallery %}
...
{% gallery %}
![部署证书（可以不开强制跳转）](../../img/article/浅谈网站泛域名/03.png)
{% endgallery %}
