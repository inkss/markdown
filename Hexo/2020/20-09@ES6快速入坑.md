...
headimg: ../../img/article/20-09@ES6快速入坑/Hexo博客封面.png
---
...
{% image '../../img/article/20-09@ES6快速入坑/image-20200906164049377.png', width=400px, bg=var(--color-card), alt='Const 变量的可变性' %}
