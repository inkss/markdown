...
icons:
  - fab fa-ubuntu red
description: 本文分享 Ubuntu 20.04 LTS 的安装体验，包括安装前期准备、系统直观体验（如界面变化、驱动自动安装等）、遇到的问题（软件源、兼容性等）及后续使用情况，附相关功能与软件生态说明。
abbrlink: 481358a6
headimg: https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/20-06@记一次Ubuntu20.04LTS安装体验/main.png
hideTitle: false
copyright:
  type: type2
---
...
{% image https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/20-06@记一次Ubuntu20.04LTS安装体验/img01.png, alt=自定义应用分组, bg=#101010, height=400px %}
...
{% image https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/20-06@记一次Ubuntu20.04LTS安装体验/img03.png, alt=Do Not Disturb, bg=#292929, height=400px %}
...
{% image https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/20-06@记一次Ubuntu20.04LTS安装体验/img04.png, alt=附加驱动, bg=var(--color-card), height=400px %}
...
{% image https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/20-06@记一次Ubuntu20.04LTS安装体验/img05.png, alt=点着是没有反应的, bg=#292929, height=400px %}
...
![火狐](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/20-06@记一次Ubuntu20.04LTS安装体验/img06.png)
![Chrome, Yes!](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/20-06@记一次Ubuntu20.04LTS安装体验/img07.png)
{% endgallery %}
...
![Motrix](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/20-06@记一次Ubuntu20.04LTS安装体验/img08.png)
![国产好软，全平台兼容](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/20-06@记一次Ubuntu20.04LTS安装体验/img10.png)
{% endgallery %}
...
![主题配置信息](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/20-06@记一次Ubuntu20.04LTS安装体验/img09.png)
![操作系统信息](https://cdn.jsdelivr.net/gh/inkss/inkss-cdn@main/img/article/20-06@记一次Ubuntu20.04LTS安装体验/img11.png)
{% endgallery %}
