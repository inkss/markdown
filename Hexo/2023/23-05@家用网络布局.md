...
![image-20230618163212359](../../img/article/23-05@家用网络布局/image-20230618163212359.png)

## 二、软路由

底层环境：ESXi 8.0.0，部署 iKuai，Ubuntu Server。

原本是打算部署一个 OpenWrt 作为旁路由，负责代理+广告过滤，后来又觉得只为了这两个功能额外调整网络结构不太至于，更何况电脑和手机可以直接安装 Clash，全局代理的需求没那么强烈，所以最终是单独安装了 Ubuntu Server 20.04 LTS，再部署宝塔面板方面管理。
...
![宝塔面板](../../img/article/23-05@家用网络布局/23-06-18_162807.png)
